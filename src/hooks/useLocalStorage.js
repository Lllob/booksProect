...
export const useLocalStorage = (key, defaultValue) => {//key = 'auth' //defaultvelue = dannite
    ...
    //vzimame dannite za usera ot localstorig
        ...
        return storijData ? JSON.parse(storijData) : defaultValue;//sas .parse  preobrazuvame dannite //ako ima danni vav localStor.,: ako ne ot defaultveluto(informacita se palni vav authContexta)
    });   
